...
Encoder.prototype._startVideoFragment = function( cb ){
	async.waterfall( [ ( cb ) => {
		...
		console.log( "Starting nc client" );
		const _ncClient = spawn( "nc", [ "localhost", "1337" ] );

		_ncClient.stdout.on( "data", function( data ){
			console.log( "I have data from nc client of " );
			console.log( data );
